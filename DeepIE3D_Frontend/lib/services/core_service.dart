...
class CoreService {
  ...
  final List<Icon> NGIcons =
      List.generate(9, (_) => Icon("cancel outlined"));
  ...
  Future<void> evolve(double mutationRate,String mode) async {
    ...
    Future<void> futureEvolution = _httpService.evolve(
        evolutionSpecifications, zs, selectedCanvases,  selectedNGs , _novelty, mutationRate,mode); ///add NG
    ...
    NGIcons.fillRange(0, 9, Icon("cancel outlined"));
